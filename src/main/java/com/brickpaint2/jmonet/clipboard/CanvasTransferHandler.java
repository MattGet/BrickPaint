...
import com.brickpaint2.jmonet.clipboard.CanvasTransferDelegate;
...
public class CanvasTransferHandler extends TransferHandler {
    ...
    private final com.brickpaint2.jmonet.clipboard.CanvasTransferDelegate delegate;
    ...
    protected Transferable createTransferable(JComponent c) {
        return com.brickpaint2.jmonet.clipboard.TransferableImage.from(delegate.copySelection());
    }

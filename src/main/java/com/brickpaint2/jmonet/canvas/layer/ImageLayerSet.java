package com.brickpaint2.jmonet.canvas.layer;

import com.brickpaint2.jmonet.canvas.layer.ImageLayer;
import com.brickpaint2.jmonet.canvas.layer.LayeredImage;
import com.brickpaint2.jmonet.canvas.observable.LayerSetObserver;
...
public class ImageLayerSet implements LayeredImage {
    ...
    private final List<com.brickpaint2.jmonet.canvas.layer.ImageLayer> layers = new ArrayList<>();
    ...
    public ImageLayerSet(BufferedImage image) {
        addLayer(new com.brickpaint2.jmonet.canvas.layer.ImageLayer(image));
    }
     ...
     */
    public ImageLayerSet(com.brickpaint2.jmonet.canvas.layer.ImageLayer layer) {
        addLayer(layer);
    }
     ...
     */
    public void addLayer(com.brickpaint2.jmonet.canvas.layer.ImageLayer layer) {
        layers.add(layer);
     ...
     */
    @Override
    public com.brickpaint2.jmonet.canvas.layer.ImageLayer[] getImageLayers() {

...
import com.brickpaint2.jmonet.tools.FillTool;
import com.brickpaint2.jmonet.tools.PolygonTool;
import com.brickpaint2.jmonet.tools.TextTool;
import com.brickpaint2.jmonet.tools.attributes.*;
import com.brickpaint2.jmonet.tools.base.BoundsTool;
import com.brickpaint2.jmonet.tools.base.Tool;
import com.brickpaint2.jmonet.tools.builder.StrokeBuilder;
import com.brickpaint2.jmonet.tools.cursors.CursorManager;
import com.brickpaint2.jmonet.tools.cursors.SwingCursorManager;
...
public class PaintToolBuilder {
    ...
    public Tool build() {
        ...
        Tool selectedTool = (Tool) Guice.createInjector(new ToolAssembly()).getInstance(type.getToolClass());

...
public class ShapeStrokeBuilder {
     ...
     * @return The builder
     */
    public ShapeStrokeBuilder ofCircle(double diameter) {
     ...
     * <p>
     * It is advised not to stroke a stroke with a {@link com.brickpaint2.jmonet.tools.brushes.StampStroke}, as doing

...
import com.brickpaint2.jmonet.canvas.surface.SurfaceScrollController;
...
public interface ToolAttributes extends ObservableToolAttributes {
     ...
     */
    com.brickpaint2.jmonet.tools.attributes.MarkPredicate getMarkPredicate();
     ...
     */
    com.brickpaint2.jmonet.tools.attributes.BoundaryFunction getBoundaryFunction();
    ...
    /**
     * Gets the function used to color the canvas with paint flooding a region. See {@link com.brickpaint2.jmonet.tools.attributes.FillFunction} for details.
     * @return The fill function being used.
     */
    com.brickpaint2.jmonet.tools.attributes.FillFunction getFillFunction();

    /**
     * Sets the function used to color the canvas with paint flooding a region. See {@link com.brickpaint2.jmonet.tools.attributes.FillFunction} for details.

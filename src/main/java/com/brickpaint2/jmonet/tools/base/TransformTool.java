package com.brickpaint2.jmonet.tools.base;

import com.brickpaint2.jmonet.canvas.observable.SurfaceInteractionObserver;
...
/**
 * A {@link com.brickpaint2.jmonet.tools.base.SelectionTool} whose rectanglular selection frame can be modified by dragging handles that are rendered by
...
public class TransformTool extends SelectionTool implements SurfaceInteractionObserver, SelectionToolDelegate {
    ...
    private com.brickpaint2.jmonet.tools.base.TransformToolDelegate transformToolDelegate;
    ...
    public com.brickpaint2.jmonet.tools.base.TransformToolDelegate getTransformToolDelegate() {
